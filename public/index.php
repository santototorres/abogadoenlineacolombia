...
<header class="header">
    <div class="container header-content">
        <div class="logo">Abogado en Línea Colombia</div>
        <nav class="nav">
            <a href="#" class="nav-link">Encontrar abogado</a>
            <a href="#" class="nav-link">Soy abogado</a>
            <a href="#" class="nav-link">Ingresar</a>
            <a href="#" class="nav-link nav-primary">Registrarme</a>
        </nav>
    </div>
</header>
